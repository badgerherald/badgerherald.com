...
function _exa_enqueue_scripts_styles() {
	...
	wp_enqueue_style( 'exa-style', get_template_directory_uri() . '/style.css', array(), "" );
	
	/** Load exa.js. (and jQuery, implicitly) */
	wp_enqueue_script('exa-script', get_template_directory_uri() . '/js/exa.js',array('jquery'), "", true );
