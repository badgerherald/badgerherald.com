            ...
            <main>
                ...
                <header class="article-header">
                    ...
                    <div class="article-meta">
                        ...
                        <span class="meta-author">
                            by
                            <a class="author-link" href="<?php exa_the_author_link() ?>"
				...
				*/ ?>
                ...
                <section class="article-footnotes">
                    ...
                    <p>This article was published <strong><?php the_time("M j, Y") ?></strong> at
                        <strong><?php the_time("g:i a"); ?></strong>, and last updated
                        <strong><?php the_modified_time("M j, Y") ?></strong> at
                        <strong><?php the_modified_time("g:i a"); ?></strong>.
                    <p>
