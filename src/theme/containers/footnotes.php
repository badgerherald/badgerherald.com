    ...
    <div class="wrapper">
        ...
        <div class="meta">
            ...
            <div class="fine-print">
                ...
                <p class="letter-to-editor-disclaimer"><em><strong>Letters to the editor</strong> are published on the
                        discretion of the opinion desk and editor. They may not reflect the views of the Herald. Email
                        your own letters to the editor to oped@badgerherald.com</em></p>
                <?php endif; ?>

                <p>This article was published <?php the_time("M j, Y") ?> at <?php the_time("g:i a"); ?> and last
                    updated <?php the_modified_time("M j, Y") ?> at <?php the_modified_time("g:i a"); ?>
                <p>
            </div>
            ...
            <div class="post-tags">
                ...
                <?php
								foreach ($post_tags as $post_tag_key => $post_tag):
									...
									?>
                <a target="_blank"
                    href="<?php echo get_tag_link( $post_tag->term_id); ?>"><?php echo ucfirst( $post_tag->name); ?></a><?php echo $comma; ?>
        ...
        <div class="tall-ad">
            <hrld-tall-ad></hrld-tall-ad>
        </div>


        <div class="more">
            <h1>Next in <a href="<?php exa_section_permalink() ?>"
                    class="section"><?php echo ucfirst( exa_get_section()); ?></a></h1>
